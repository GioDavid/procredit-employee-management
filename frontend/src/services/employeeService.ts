...
export async function listEmployees(departamento?: string): Promise<Empleado[]> {
  const query =
...
export async function createEmployee(request: CreateEmployeeRequest): Promise<Empleado> {
